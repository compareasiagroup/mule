...
/**
 * Abstract implementation of {@link SoapComponentWrapper}
 *
 * @since 4.0
 */
abstract class SoapComponentWrapper extends TypeWrapper implements WithConnectionProviders {
  ...
  public List<ConnectionProviderElement> getConnectionProviders() {
    ...
    if (annotation.isPresent()) {
      return stream(annotation.get().value()).map(e -> new SoapConnectionProviderTypeWrapper(e)).collect(toList());
    }
    return emptyList();
  }
